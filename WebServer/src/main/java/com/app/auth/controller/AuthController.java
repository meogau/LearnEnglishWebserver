...
import com.app.auth.helper.JwtUtils;
import com.app.auth.helper.MessageResponse;
import com.app.auth.model.JwtResponse;
import com.app.auth.model.LoginRequest;
import com.app.auth.model.SignupRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        userService.addUserInfo(user.getId(),user.getUsername());
